...
INSERT INTO API.USUARIO (ID_USUARIO, NOME, LOGIN, SENHA, EMAIL, PERMISSOES) VALUES (API.SQ_ID_USUARIO.nextval,'root','root', '$2a$12$gvZEYfhpSiMN3AGRk4WqveirAlBkBBYbQj8gy9RoUSQG.XCDeIAD6','root@root.com', '');
INSERT INTO API.USUARIO (ID_USUARIO, NOME, LOGIN, SENHA, EMAIL, PERMISSOES) VALUES (API.SQ_ID_USUARIO.nextval,'braga','braga','$2a$12$gvZEYfhpSiMN3AGRk4WqveirAlBkBBYbQj8gy9RoUSQG.XCDeIAD6','luisaugustobraga@gmail.com', '');